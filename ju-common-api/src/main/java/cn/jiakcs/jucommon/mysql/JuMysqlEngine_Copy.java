...
//
//import cn.jiakcs.jucommon.mysql.model.DbColModel;
//import cn.jiakcs.jucommon.mysql.model.DbRowModel;
//
...
//
//public class JuMysqlEngine_Copy {
//    private static final long serialVersionUID = 1L;
//
//    protected List<DbColModel> colUpdateList = new ArrayList<>();
...
//    protected List<DbColModel> colData = new ArrayList<DbColModel>();
//
//    /**
//     * 填充资源
//     */
//    protected void fillObject(DbRowModel newData){
//        clearCols();
...
//        colUpdateList.add(new DbColModel(sName,sValue,sType));
//    }
//
//    /**
//     * 清空临时数据更新表
...
//     * @param newCol 新字段
//     */
//    protected void addNewCol(DbColModel newCol){
//        colData.add(newCol);
//    }
//
//    /**
...
//        addNewCol( new DbColModel(sName,sValue));
//    }
//
//    /**
//     * 获取字段
//     * @param colName 字段名称
//     */
//    private DbColModel getCol(String colName){
//        for(DbColModel one : colData){
...
//     * 获取主键字段
//     */
//    private DbColModel getMainKeyCol(){
//        for(DbColModel one : colData){
//            if (one.isMainKey())
//                return one;
//        }
...
//        DbColModel Item = getCol(colName);
//        if (Item != null){
...
//     * 获取数据行的 Json 值
//     */
//    public List<DbColModel> getCols(){
//        return colData;
//    }
//
//    /*
